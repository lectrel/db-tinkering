...
namespace DB_tinkering.DB.Migrations
{
    ...
    [Migration("20250214152639_Initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DB_tinkering.Models.Location", b =>
                {
            ...
            modelBuilder.Entity("DB_tinkering.Models.OrderProposal", b =>
                {
            ...
            modelBuilder.Entity("DB_tinkering.Models.Product", b =>
                {
                    b.Property<string>("Code")
                        .HasColumnType("text")
                        .HasColumnName("code");
            ...
            modelBuilder.Entity("DB_tinkering.Models.ProductGroup", b =>
                {
                    b.Property<string>("Code")
                        .HasColumnType("text")
                        .HasColumnName("code");
            ...
            modelBuilder.Entity("DB_tinkering.Models.Supplier", b =>
                {
                    b.Property<string>("Code")
                        .HasColumnType("text")
                        .HasColumnName("code");
            ...
            modelBuilder.Entity("DB_tinkering.Models.OrderProposal", b =>
                {
                    b.HasOne("DB_tinkering.Models.Location", "Location")
                        .WithMany()
                    ...
                    b.HasOne("DB_tinkering.Models.Product", "Product")
                        .WithMany()
            ...
            modelBuilder.Entity("DB_tinkering.Models.Product", b =>
                {
                    b.HasOne("DB_tinkering.Models.ProductGroup", "ProductGroup")
                        .WithMany()
                        .HasForeignKey("ProductGroupCode")
                        .HasConstraintName("fk_products_product_groups_product_group_code");

                    b.HasOne("DB_tinkering.Models.Supplier", "Supplier")
                        .WithMany()
